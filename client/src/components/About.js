...
import styled from 'styled-components'
 ...
 const About = () =>(
  <Div>
    ...
    <p style={{fontSize:'1.10vw',}}>I am originally from South India. I did my Electrical Engineering from Anna University, Chennai, TamilNadu, India.</p>
    <p style={{fontSize:'1.10vw',}}>I have 3.5 years of IT experience working for Infosys Ltd., Chennai. 
    ...
    <p style={{fontSize:'1.10vw',}}> Apart from coding, I love dancing, travelling, exploring different cuisines and spending time with family and friends. 
